...
import { privacyPolicyCategories } from "@/data/privacyPolicy";

interface PrivacyPolicyCategoriesProps {
  selectedCategory: string;
  onCategoryChange: (category: string) => void;
}

export default function PrivacyPolicyCategories({
  selectedCategory,
  onCategoryChange,
}: PrivacyPolicyCategoriesProps) {
  return (
    <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
      {privacyPolicyCategories.map((category) => {
